    ...
    return (
      <input
        ...
        className={cn(
          ...
          "border-[hsl(var(--color-input))] bg-[hsl(var(--color-background))] text-[hsl(var(--color-foreground))]",
          "placeholder:text-[hsl(var(--color-muted-foreground))]",
          "focus-visible:ring-[hsl(var(--color-ring))] ring-offset-[hsl(var(--color-background))]",
          className
        )}
        ref={ref}
        {...props}
